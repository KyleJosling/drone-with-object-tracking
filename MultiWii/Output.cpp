...
void mixTable() {
  ...
  #elif defined( HEX6X )/////////////////////////////////////////////////////////////////////////////
// Pins are..{9,10,11,3,6,5,A2,12
//    motor[0] = PIDMIX(-1,+1,-1); //REAR_R//
//    motor[1] = PIDMIX(-1,-1,+1); //FRONT_R//
//    motor[2] = PIDMIX(+1,+1,+1); //REAR_L//
//    motor[3] = PIDMIX(+1,-1,-1); //FRONT_L
    //motor[0] = PIDMIX(-1,+1,-1); //REAR_R NOW 9
    //motor[1] = 0; //AVOID THIS ONE!!!
    //motor[2] = 0; //USED FOR MOSI **MIGHT HAVE TO NOT DECLARE THIS AT ALL.
//    motor[3] = PIDMIX(+1,+1,+1); //REAR L NOW 3
//    motor[4] = PIDMIX(+1,-1,-1); //FRONT L NOW 6
//    motor[5] =PIDMIX(-1,-1,+1); //FRONT R NOW 5
  #elif defined( HEX6H )
    motor[0] = PIDMIX(-1,+1,-1); //REAR_R
    motor[1] = PIDMIX(-1,-1,+1); //FRONT_R
    motor[2] = PIDMIX(+ 1,+1,+1); //REAR_L
